...
async function load(){
 ...
 try{
  ...
  msg(`Wczytano ${routes.length} tras. V6.2: naprawiono rysowanie planu; atrakcje są dodawane jako punkty pośrednie trasy z możliwością usunięcia.`);
...
function downloadBackup(){
 const data={version:'6.2',created:new Date().toISOString(),routes,features,imported:getImported()};
